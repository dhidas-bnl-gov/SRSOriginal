...
osc.add_undulator(bfield=[0, 1, 0], period=[0, 0, 0.049], nperiods=21, translation=[0, 0, -dist_between_centers])
osc.add_undulator(bfield=[0, 1, 0], period=[0, 0, 0.049], nperiods=21, translation=[0, 0, +dist_between_centers])
osc.add_magnetic_field_uniform(bfield=[0, -0.4, 0], width=[0, 0, 0.5], translation=[0, 0, -2])
osc.add_magnetic_field_uniform(bfield=[0, -0.4, 0], width=[0, 0, 0.5], translation=[0, 0, +2])

# Just to check the field that we added seems visually correct
plot_magnetic_field(osc, -2, 2)
